...
export function displayQuestion(question: IQuestion, arrLength: number) {
    ...
    question.answers.forEach((answer, index) => {
        ...
        answerParagraph.addEventListener('click', (event: Event) => checkAnswer(index, question, event, arrLength));
